    ...
    async fn(req, res, next){
        ...
        if(req.method === "GET" || req.method === "POST"){
            ...
            if(req.method === "GET"){
                ...
                const authorizedAuthors = typeof this.authors === 'function' ? (doc._id ? this.authors({doc: doc, userAccess: this.userAccess}) : true) : this.authors;
